class AddFlowData < ActiveRecord::Migration
  def up
    add_column :spree_products, :flow_data, :jsonb, default: '{}'
    add_column :spree_variants, :flow_data, :jsonb, default: '{}'
    add_column :spree_orders, :flow_data, :jsonb, default: '{}'
    add_column :spree_promotions, :flow_data, :jsonb, default: '{}'
    add_column :spree_credit_cards, :flow_data, :jsonb, default: '{}'
  end
